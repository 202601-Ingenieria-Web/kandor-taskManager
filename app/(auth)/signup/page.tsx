              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" name="name" type="text" placeholder="Tu nombre" required className="bg-background pl-10" />
                  </div>
                </Field>
                ...
                <Field>
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" name="email" type="email" placeholder="tu@correo.com" required className="bg-background pl-10" />
                  </div>
                </Field>
                ...
                <Field>
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" name="password" type="password" required className="bg-background pl-10" />
                  </div>
                </Field>
